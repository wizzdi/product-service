...
public class StatusLinkToImageContainer {
	...
	public StatusLinkToImageContainer(StatusLinkToImage other) {
		...
		this.productTypeId = other.getStatusLink() != null
				&& other.getStatusLink().getLeftside() != null ? other
				.getStatusLink().getLeftside().getId() : null;
		this.productStatusId = other.getStatusLink() != null
				&& other.getStatusLink().getRightside() != null ? other
				.getStatusLink().getRightside().getId() : null;
	}
	...
	public <T extends StatusLinkToImageContainer> T setDescription(
			String description) {
	...
	public <T extends StatusLinkToImageContainer> T setStatusLink(
			ProductTypeToProductStatus statusLink) {
	...
	public <T extends StatusLinkToImageContainer> T setProductTypeId(
	...
	public <T extends StatusLinkToImageContainer> T setProductStatusId(
