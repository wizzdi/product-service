...
public class PaginationResponse<T> {
    ...
    public PaginationResponse(List<T> list, FilteringInformationHolder filteringInformationHolder, long totalRecords) {
        this.list = list;
        this.startPage=filteringInformationHolder.getCurrentPage();
        this.totalRecords=totalRecords;
        this.endPage=filteringInformationHolder.getCurrentPage()+ (list.size()/filteringInformationHolder.getPageSize());
        this.totalPages=totalRecords/filteringInformationHolder.getPageSize();
    }
