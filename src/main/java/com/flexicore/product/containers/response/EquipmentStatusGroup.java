...
public class EquipmentStatusGroup {
	...
	public EquipmentStatusGroup(String statusId, String statusName,
			String statusDescription, Long count) {
		this.count = count;
	...
	public EquipmentStatusGroup(String tenantId, String tenantName,
			String statusId, String statusName, String statusDescription,
			Long count) {
		this.count = count;
		this.statusName = statusName;
		this.statusDescription = statusDescription;
	...
	public EquipmentStatusGroup(Long count, String statusId, String statusName,
			String statusDescription, String prodcutTypeId,
	...
	public <T extends EquipmentStatusGroup> T setProductTypeId(
	...
	public <T extends EquipmentStatusGroup> T setProductTypeName(
			String productTypeName) {
		this.productTypeName = productTypeName;
		return (T) this;
	}
