...
public class ProductStatusToProductCreate {
   ...
   private ProductStatus productStatus;
    ...
    public ProductStatusToProductCreate setProductStatusId(String productStatusId) {
    ...
    public ProductStatusToProductCreate setProductStatus(ProductStatus productStatus) {
