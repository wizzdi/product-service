...
public class SingleInspectJob<S extends com.flexicore.iot.ExternalServer, C extends com.flexicore.product.request.ConnectionHolder<S>> {
    ...
    public SingleInspectJob(String id,String externalServerId,String configurationId,LocalDateTime timeToInspect) {
        this.id = id;
    ...
    public <T extends SingleInspectJob<S, C>> T setConnectionHolder(C connectionHolder) {
