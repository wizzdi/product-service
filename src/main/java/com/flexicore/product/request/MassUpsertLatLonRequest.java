...
public class MassUpsertLatLonRequest {
    ...
    public <T extends MassUpsertLatLonRequest> T setList(List<LatLonContainer> list) {
        this.list = list;
        return (T) this;
    }
    ...
    public <T extends MassUpsertLatLonRequest> T setMultiLatLonEquipmentId(String multiLatLonEquipmentId) {
