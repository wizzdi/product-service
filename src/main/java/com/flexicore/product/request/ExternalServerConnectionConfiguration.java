...
public class ExternalServerConnectionConfiguration<S extends com.flexicore.iot.ExternalServer, C extends com.flexicore.product.request.ConnectionHolder<S>> {
	...
	public ExternalServerConnectionConfiguration(Supplier<List<S>> onRefresh,
			Function<S, C> onConnect,
			Function<C, GenericInspectResponse> onInspect) {
		this();
	...
	public <T extends ExternalServerConnectionConfiguration<S, C>> T setSingleInspectJobs(
			LinkedBlockingQueue<SingleInspectJob<S, C>> singleInspectJobs) {
		this.singleInspectJobs = singleInspectJobs;
		return (T) this;
	}

	public <T extends ExternalServerConnectionConfiguration<S, C>> T setOnRefresh(
			Supplier<List<S>> onRefresh) {
		this.onRefresh = onRefresh;
		return (T) this;
	}
	...
	public <T extends ExternalServerConnectionConfiguration<S, C>> T setOnConnect(
			Function<S, C> onConnect) {
		this.onConnect = onConnect;
		return (T) this;
	}
	...
	public <T extends ExternalServerConnectionConfiguration<S, C>> T setOnInspect(
			Function<C, GenericInspectResponse> onInspect) {
		this.onInspect = onInspect;
		return (T) this;
	}
	...
	public <T extends ExternalServerConnectionConfiguration<S, C>> T setCache(
			List<S> cache) {
		this.cache = cache;
		return (T) this;
	}
	...
	public <T extends ExternalServerConnectionConfiguration<S, C>> T setLastCacheRefresh(
	...
	public <T extends ExternalServerConnectionConfiguration<S, C>> T setConnectionHolders(
			Map<String, C> connectionHolders) {
	...
	public <T extends ExternalServerConnectionConfiguration<S, C>> T setOnSingleInspect(
			Function<SingleInspectJob<S, C>, GenericInspectResponse> onSingleInspect) {
	...
	public <T extends ExternalServerConnectionConfiguration<S, C>> T setId(
			String id) {
		this.id = id;
		return (T) this;
	}
