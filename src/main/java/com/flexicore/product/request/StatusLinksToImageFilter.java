...
public class StatusLinksToImageFilter extends FilteringInformationHolder {
    ...
    public <T extends StatusLinksToImageFilter> T setStatusIds(Set<String> statusIds) {
    ...
    public <T extends StatusLinksToImageFilter> T setProductTypeIds(Set<String> productTypeIds) {
    ...
    public <T extends StatusLinksToImageFilter> T setStatusLinkIds(Set<String> statusLinkIds) {
    ...
    public <T extends StatusLinksToImageFilter> T setStatus(List<ProductStatus> status) {
        this.status = status;
        return (T) this;
    }
    @JsonIgnore
    ...
    public <T extends StatusLinksToImageFilter> T setProductTypes(List<ProductType> productTypes) {
    ...
    public <T extends StatusLinksToImageFilter> T setStatusLinks(List<ProductTypeToProductStatus> statusLinks) {
