...
public class DetailedEquipmentStatus {
    ...
    public <T extends DetailedEquipmentStatus> T setEquipmentId(String equipmentId) {
    ...
    public <T extends DetailedEquipmentStatus> T setEquipmentByStatusEntry(String equipmentByStatusEntry) {
