...
public class ExternalServerUserCreate {
	...
	public <T extends ExternalServerUserCreate> T setDescription(
			String description) {
	...
	public <T extends ExternalServerUserCreate> T setExternalServerId(
	...
	public <T extends ExternalServerUserCreate> T setExternalServer(
