 ...
 */
public class FlexiCoreIOTRequestMessageEncoder implements Encoder.TextStream<FlexiCoreIOTRequest> {
    ...
    @Override
    public void encode(FlexiCoreIOTRequest object, Writer writer) throws IOException {
